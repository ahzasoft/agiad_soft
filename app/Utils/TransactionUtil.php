...
/*dd($transaction->status .' : '.$transaction->is_quotation .' : ' .$transaction->sub_status);*/
       ...
       /* dd( $output['invoice_heading']);*/
        ...
        /* Tax for invoice */
        /* Add product Tax to invoice tax 2022-1-14*/
         $transaction->tax_amount = $transaction->tax_amount + $total_line_taxes;
         $output['tax_label'] .= ':';
       ...
       /* E-invoice Qrcode New Qr-Code eng ali */
        $total_order_tax = $transaction->tax_amount ; // Total Tax invice + Product
      ...
      /* Add for new addition*/
        $output['transaction_add']=$transaction->transaction_add;
        $output['transaction_add_value']= $this->num_f($transaction->transaction_add_value, $show_currency, $business_details);
        $output['transaction_add_total']=$this->num_f($transaction->final_total- $transaction->transaction_add_value, $show_currency, $business_details);
