    ...
    <div class="modal-content" >
        <div class="modal-header">
            ...
            <h4 class="modal-title">@lang( 'inventory::lang.Inventory_add' )</h4>
             ...
             <form action="{{action('\Modules\Inventory\Http\Controllers\InventoryController@store')}}" method="POST">
                @csrf
                 <div class="flex-container">
                     ...
                     <div class="form-group" style="margin: 15px;min-width: 150px">
                         ...
                         <input type="text" class="form-control date-picker" name="end_date"  required value="" >
                     </div>
                     <div class="form-group" style="margin: 15px;min-width: 150px">
