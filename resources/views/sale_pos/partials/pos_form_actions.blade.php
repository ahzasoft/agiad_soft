	...
	<div class="pos-form-actions">
		<div class="col-md-12">
	     @if($is_mobile)
			...
			<button type="button" 
				class="btn bg-maroon btn-default btn-flat no-print @if(!empty($pos_settings['disable_credit_sale_button'])) hide @endif pos-express-finalize @if(!array_key_exists('card', $payment_types)) hide @endif @if($is_mobile) col-xs-6 @endif"
